...
var map = {
	"./copy_controller.js": "./resources/js/controllers/copy_controller.js",
	"./feature_controller.js": "./resources/js/controllers/feature_controller.js",
	"./inputfile_controller.js": "./resources/js/controllers/inputfile_controller.js",
	"./print_controller.js": "./resources/js/controllers/print_controller.js",
	"./register_controller.js": "./resources/js/controllers/register_controller.js",
...
/***/ "./resources/js/controllers/copy_controller.js":
/*!*****************************************************!*\
  !*** ./resources/js/controllers/copy_controller.js ***!
  \*****************************************************/
...
/***/ "./resources/js/controllers/inputfile_controller.js":
/*!**********************************************************!*\
  !*** ./resources/js/controllers/inputfile_controller.js ***!
  \**********************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "uploadFile",
    value: function uploadFile(file) {// var formData = new FormData();
...
_default.targets = ["source", "listContainer", "listTemplate", "list"];
...
/***/ "./resources/js/controllers/register_controller.js":
/*!*********************************************************!*\
  !*** ./resources/js/controllers/register_controller.js ***!
  \*********************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function validateUsername() {
      var url = "/api/validators/username?username=" + this.usernameTarget.value;
      var usernameError = this.usernameErrorTarget;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (response) {
        ...
        usernameError.innerText = JSON.parse(error.request.response).errors.username[0];
    ...
    value: function validateEmail() {
      var url = "/api/validators/email?email=" + this.emailTarget.value;
      var emailError = this.emailErrorTarget;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (response) {
        // Unique username
        ...
        // Problem with username
        emailError.innerText = JSON.parse(error.request.response).errors.email[0];
...
_default.targets = ["username", "usernameError", "email", "emailError"];
