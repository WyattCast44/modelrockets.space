@modal(['name' => 'share'])
    ...
    <h1 class="font-semibold uppercase text-2xl mb-2">Share this thread</h1>
    ...
    <p class="text-gray-700 mb-4">
        ...
        the url to this thread and share wherever you wish! 🚀
    </p>

    <div data-controller="click-to-copy" class="flex items-center">
        <input data-target="click-to-copy.source" type="text" class="form-control m-0 form-control-lg bg-blue-100 italic text-sm rounded-r-none" value="{{ $thread->path(true) }}" contenteditable="true">
