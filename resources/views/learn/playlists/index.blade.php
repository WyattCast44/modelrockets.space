...
<header class="flex flex-col py-12 mb-8 bg-gray-200 border-b border-gray-300 border-solid">
    <div class="container flex flex-col-reverse flex-wrap items-center justify-center sm:flex-col sm:flex-no-wrap">
        ...
        <div class="flex items-center justify-end object-cover mb-5 sm:mb-0">
