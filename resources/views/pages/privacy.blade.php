...
<header class="flex flex-col py-12 bg-gray-200 border-b border-gray-300 border-solid">
    <div class="container">
        <h1 class="mb-2 text-3xl font-semibold">Privacy Policy</h1>
        <p class="text-lg text-gray-700">
            We do our best to be transparent and collect as little information as possible.
        </p>
    </div>
</header>
...
<div class="container pt-8 pb-16 mx-auto">
    ...
    <div class="flex items-center justify-center mb-4 sm:mb-6 md:mb-8 md:justify-start print:hidden">
        ...
        <x-share title="Privacy Policy" ></x-share>

        <a href="https://github.com/WyattCast44/modelrockets.space/blob/master/resources/views/pages/_content/privacy.md" target="_blank" class="ml-2 btn btn-outline-primary btn-sm" data-turbolinks="false">📝 Edit on GitHub</a>
