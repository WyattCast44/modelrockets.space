@modal(['name' => 'share'])
    ...
    <div data-controller="click-to-copy" class="flex items-center">
        <input data-target="click-to-copy.source" type="text" class="form-control m-0 form-control-lg bg-blue-100 italic text-sm rounded-r-none" value="{{ $article->path('show') }}" contenteditable="true">
